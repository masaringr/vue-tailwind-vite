<template>
    <div class="flex gap-4 pb-4 border-b-2 border-gray-200">
        <router-link :to="baseURL+'/profile/personal_data'" exact v-slot="{ isExactActive }">
